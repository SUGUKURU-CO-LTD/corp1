        ...
        <div className="min-h-screen bg-canvas py-16">
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
                    <h1 className="text-3xl md:text-4xl font-bold text-ink border-b-4 border-accent pb-4 mb-6">
                    ...
                    <section className="mb-16">
                        <h2 className="text-2xl font-bold text-ink border-l-4 border-accent pl-4 mb-6">
                            日本語版
                        </h2>

                        <div className="space-y-8">
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">1. はじめに</h3>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">2. 収集する情報</h3>
                                <p className="text-ink mb-3">本アプリでは、以下の情報を収集します：</p>

                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.1 アカウント情報</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.2 本人確認情報（eKYC）</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.3 金融情報</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.4 デバイス情報</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                            <li>デバイスID</li>
                                            <li>IPアドレス</li>
                                            <li>OS種別・バージョン</li>
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.5 利用情報</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                            <li>アプリの利用履歴</li>
                                            <li>画面遷移情報</li>
                                            <li>エラーログ</li>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">3. 情報の利用目的</h3>
                                <p className="text-ink mb-3">収集した情報は、以下の目的で利用します：</p>

                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.1 サービス提供</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                            <li>送金サービスの提供</li>
                                            <li>アカウント管理</li>
                                            <li>カスタマーサポート</li>
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.2 法令遵守</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.3 サービス改善</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                            <li>サービス品質の向上</li>
                                            <li>新機能の開発</li>
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.4 セキュリティ</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                            <li>不正利用の防止</li>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">4. 第三者への提供</h3>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">4.1 サービス提供に必要な提携先</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">4.2 法令に基づく場合</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">5. 情報の保管・セキュリティ</h3>

                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">5.1 データの保管</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">5.2 セキュリティ対策</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">5.3 保管期間</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">6. ユーザーの権利</h3>
                                <p className="text-ink mb-3">ユーザーは、以下の権利を有します：</p>
                                <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">7. Cookie・トラッキング技術</h3>
                                <p className="text-ink mb-3">本アプリでは、以下の技術を使用する場合があります：</p>
                                <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">8. 未成年者の情報</h3>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">9. プライバシーポリシーの変更</h3>
                                <p className="text-ink">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">10. お問い合わせ</h3>
                    ...
                    <section>
                        ...
                        <div className="space-y-8">
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">1. Pendahuluan</h3>
                                <p className="text-ink leading-relaxed">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">2. Informasi yang Dikumpulkan</h3>
                                <p className="text-ink mb-3">Aplikasi ini mengumpulkan informasi berikut:</p>

                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.1 Informasi Akun</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.2 Informasi Verifikasi Identitas (eKYC)</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.3 Informasi Keuangan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.4 Informasi Perangkat</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                            <li>ID perangkat</li>
                                            <li>Alamat IP</li>
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">2.5 Informasi Penggunaan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">3. Tujuan Penggunaan Informasi</h3>
                                <p className="text-ink mb-3">Informasi yang dikumpulkan digunakan untuk tujuan berikut:</p>

                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.1 Penyediaan Layanan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.2 Kepatuhan Hukum</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.3 Peningkatan Layanan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">3.4 Keamanan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">4. Pembagian kepada Pihak Ketiga</h3>
                                <p className="text-ink mb-3">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">4.1 Mitra yang Diperlukan untuk Penyediaan Layanan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">4.2 Berdasarkan Hukum</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">5. Penyimpanan dan Keamanan Informasi</h3>

                                <div className="space-y-4">
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">5.1 Penyimpanan Data</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">5.2 Langkah-langkah Keamanan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-ink mb-2">5.3 Periode Penyimpanan</h4>
                                        <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">6. Hak Pengguna</h3>
                                <p className="text-ink mb-3">Pengguna memiliki hak-hak berikut:</p>
                                <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">7. Cookie dan Teknologi Pelacakan</h3>
                                <p className="text-ink mb-3">Aplikasi ini dapat menggunakan teknologi berikut:</p>
                                <ul className="list-disc list-inside space-y-1 text-ink ml-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">8. Informasi Anak di Bawah Umur</h3>
                                <p className="text-ink">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">9. Perubahan Kebijakan Privasi</h3>
                                <p className="text-ink">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-ink mb-3">10. Kontak</h3>
                                <div className="bg-canvas rounded-lg p-6">
                                    <p className="text-ink leading-relaxed">
                    ...
                    {/* Footer */}
                    <div className="mt-12 pt-6 border-t border-line text-center text-sm text-ink-muted">
                        <p className="mb-2">
